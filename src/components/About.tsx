...
        <h3 className={`${isMobile ? 'text-unified-2xl' : 'text-unified-3xl'} font-primary font-unified-bold text-gray-900 mb-4`}>{value.title}</h3>
        <p className={`${isMobile ? 'text-unified-base' : 'text-unified-lg'} font-primary font-unified-normal text-gray-700 leading-unified-relaxed`}>{value.description}</p>
      </div>
    </div>
  );
};
...
            <h2 className="text-unified-5xl md:text-unified-4xl font-primary font-unified-bold text-gray-900 mb-4">
              We're empowering you for financial excellence
            </h2>
          </AnimatedSection>
          <AnimatedSection animationType="fadeUp" delay={400}>
            <p className="text-unified-xl font-primary font-unified-normal text-gray-700 max-w-3xl mx-auto leading-unified-relaxed">
