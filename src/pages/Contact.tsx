...
      answer: "Pepcode offers flexible pricing plans based on your specific requirements. For a detailed quote, please reach out to our sales team through the contact form."
    },
    {
...
      answer: "Audits conducted through AuditMe are performed by our network of accredited and independent auditing firms, guaranteeing a thorough and unbiased review of your financial statements."
    },
    {
...
                    type="text"
                    id="company"
          _message" className="block text-sm font-medium text-gray-700 mb-2">
                    Message
                  </label>
                  <textarea
                    id="message"
...
                    </AccordionItem>
                ))}
  _4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                <p className="text-sm font-bold text-blue-400 uppercase">FAQ</p>
                <h2 className="text-4xl font-bold text-white mt-2 mb-4">Frequently Asked Questions</h2>
                <p className="text-lg text-gray-300 max-w-2xl mx-auto">
