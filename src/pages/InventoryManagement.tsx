...
const InventoryManagement = () => {
	const handleSubmit = (e: React.FormEvent) => {
		...
		const res = axios.post(
			'https://ploutospage-server.onrender.com/inventory/submit',
			data,
		);
		res
			.then((response) => {
				if (response.status === 200) {
					alert(
						'Your custom inventory management services quote has been submitted successfully!',
					);
				} else {
					alert(
			...
			<section className="pt-32 pb-20 bg-gray-50">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-base md:text-xl text-gray-600 max-w-4xl mx-auto">
						Simplify inventory tracking, manage stock
						levels, and optimize inventory turnover with our
						advanced inventory management solutions. Stay on
						top of stock levels, reduce costs, and improve
						efficiency.
					</p>
				</div>
			</section>
					...
					<div className="max-w-3xl mx-auto">
						<div className="bg-gray-50 rounded-2xl p-8">
							...
							<p className="text-sm md:text-lg text-gray-600 mb-8 text-center">
								Help us understand your inventory needs to
								provide you with the most suitable
								management solution and pricing.
							</p>
