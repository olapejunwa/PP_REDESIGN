...
const BookkeepingServices = () => {
	const handleSubmit = (e: React.FormEvent) => {
		...
		const data = {
			...
			monthly_transactions: formData.get(
				'monthlyTransactions',
			),
			...
			<section className="pt-32 pb-20 bg-gray-50">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-base md:text-xl text-gray-600 max-w-4xl mx-auto">
						Our bookkeeping services are tailored to meet
						the unique needs of SMEs and medium-sized
						businesses. Whether you need assistance with
						day-to-day bookkeeping tasks, or financial
						reporting, our team is here to help. We ensure
						accuracy, compliance, and efficiency, allowing
					...
					<div className="max-w-3xl mx-auto">
						<div className="bg-gray-50 rounded-2xl p-8">
							...
							<p className="text-sm md:text-lg text-gray-600 mb-8 text-center">
								Tell us about your business to receive a
								tailored bookkeeping package that fits your
