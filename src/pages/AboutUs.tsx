...
const AboutUs = () => {
  ...
  const team = [
    ...
    }, // <-- FIXED: Added a comma
    {
        ...
        image: "/images/ADEBUKOLA.jpg", // <-- FIXED: Closed the string with a quote
  ...
  const clients = [
    { src: "/images/Daddyplug.ng logo.png", alt: "Daddyplug.ng Logo" },
    { src: "/images/Ardawatter logo.png", alt: "Ardawatter Logo" },
    { src: "/images/Nutrition Kids logo.png", alt: "Nutrition Kids Logo" },
    { src: "/images/Jabulani Express logos.png", alt: "Jabulani Express Logo" },
  ];
...
Whether you're a startup, a small business, or a woman selling in the open market — we’ve got you covered.
            ...
            {clients.map((client, index) => (
              <div key={index} className="flex justify-center">
                <img
                  src={client.src}
                  alt={client.alt}
                  className="h-48 lg:h-64 object-contain transition-transform duration-300 ease-in-out hover:scale-110"
                />
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* IMPROVED: Changed flex to a responsive grid for better layout */}
