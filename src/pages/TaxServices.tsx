...
const TaxServices = () => {
	const handleSubmit = (e: React.FormEvent) => {
		...
		const res = axios.post(
			'https://ploutospage-server.onrender.com/tax-services/submit',
			data,
		);
		res
			.then((response) => {
				if (response.status === 200) {
					alert(
						'Your custom tax services quote has been submitted successfully!',
					);
				} else {
					alert(
			...
			<section className="pt-32 pb-20 bg-gray-50">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-base md:text-xl text-gray-600 max-w-4xl mx-auto">
						Navigate the complexities of tax compliance with
						ease. Our tax experts offer comprehensive tax
					...
					<div className="max-w-3xl mx-auto">
						<div className="bg-gray-50 rounded-2xl p-8">
							...
							<p className="text-sm md:text-lg text-gray-600 mb-8 text-center">
								Help us understand your business needs to
								provide you with the most suitable tax
							...
							>
								...
								<div>
									...
									>
										...
										<option value="20m-100m">
											₦20 Million - ₦100 Million
										</option>
										<option value="over-100m">
											Over ₦100 Million
										</option>
									</select>
								</div>
								...
								<div>
									...
									>
										...
										<option value="simple">
											Simple (Basic income tax filing)
										</option>
										<option value="moderate">
											Moderate (Multiple income sources,
											VAT)
										</option>
										<option value="complex">
											Complex (Multiple entities,
